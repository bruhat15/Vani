    ...
    <div className={`flex flex-col h-full overflow-hidden ${className}`}>
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
        <div className="flex items-center space-x-2 mb-2">
          <div className="w-6 h-6 rounded border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 flex items-center justify-center flex-shrink-0 overflow-hidden">
            {getSourceIcon(citation.source_type)}
          </div>
          <span className="font-medium text-gray-900 dark:text-slate-100 truncate">{citation.source_title}</span>
        </div>
      </div>
        ...
        <div className="border-b border-gray-200 dark:border-gray-800 flex-shrink-0">
          <Accordion type="single" value={accordionValue} onValueChange={setAccordionValue} collapsible>
            <AccordionItem value="guide" className="border-0">
              <AccordionTrigger 
                className="px-4 py-3 text-sm font-medium text-[#234776] dark:text-slate-200 hover:no-underline hover:bg-blue-50 dark:hover:bg-slate-800"
              >
                  ...
                  {citation.source_type === 'website' && sourceUrl && (
                    <div>
                      ...
                      <a 
                        ...
                        className="break-all text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 hover:underline"
                      >
                        {sourceUrl}
                      </a>
                    </div>
      ...
      <ScrollArea className="flex-1 h-full" ref={scrollAreaViewportRef}>
        <div className="p-4">
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-1">
